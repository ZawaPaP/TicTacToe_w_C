...
COMMON_SRCS := src/board.c src/game.c src/plays.c src/queue.c src/cpu.c src/utils.c
...
TEST_SRCS := tests/test_main.c tests/test_utils.c tests/test_board.c tests/test_plays.c tests/test_game.c tests/test_queue.c tests/test_cpu.c
